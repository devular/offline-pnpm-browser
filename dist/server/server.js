...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DIwH6qW1.js");
...
var manifest = {
	"2f90cce3bd72cc87be12acc92df61f7e770404304daf1c51b7e4a1914e7d2400": {
		functionName: "getCategories_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	},
	"df64fca21397597a7ee29855c3b153753f3683f4358f19393978070e415493ef": {
		functionName: "getCategoryDetail_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	},
	"5195994a82d9f13c1bf8ee88ac03a8f994fba33e706c292808d837faceec435b": {
		functionName: "searchPackages_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	},
	"21b4ed27efbf051ff1307fb82e31422c7e3cfc98dd52b303d84730bb7404a059": {
		functionName: "getPackageDetail_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	},
	"80bd4c64d1aa9ca210163ac8a233631ea938ab40660a6922d84ac1da78fe5526": {
		functionName: "getDependents_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	},
	"72819aefc8657151371f6a73df7ec1161c8d91bb03e9ecaec39724416b029e3e": {
		functionName: "getPackageVersions_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	},
	"d3a5312132b52da2c67ad8cfa3847698cb76f89d7745b6928f9aced9e63bc785": {
		functionName: "getDbStats_createServerFn_handler",
		importer: () => import("./assets/packages.functions-BBYI7TX0.js")
	}
};
...
//#endregion
//#region node_modules/.pnpm/@tanstack+start-client-core@1.167.2/node_modules/@tanstack/start-client-core/dist/esm/getStartContextServerOnly.js
...
async function loadEntries() {
	const routerEntry = await import("./assets/router-pad-V2NM.js");
	return {
		startEntry: await import("./assets/start-CHEQZ8CA.js"),
		routerEntry
	};
}
function getEntries() {
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-start@1.167.3_react-dom@19.2.4_react@19.2.4__react@19.2.4_vite@8.0.1_@t_b82ef8f29736859611a1647491e75a04/node_modules/@tanstack/react-start/dist/plugin/default-entry/server.ts
